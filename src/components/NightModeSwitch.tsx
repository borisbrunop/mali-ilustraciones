...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
    ...
    '& .MuiSwitch-thumb': {
        backgroundColor: theme.palette.mode === 'dark' ? '#BA5743' : '#FFDBA3',
        width: 30,
        height: 30,
        '&:before': {
            content: "''",
...
export default function NightModeSwitch() {
    ...
    return (
        ...
        <Box style={{
            ...
            <FormGroup >
                <FormControlLabel
                    control={<MaterialUISwitch sx={{ m: 0 }} checked={theme.palette.mode === 'light' ? false : true} onClick={c.actions.toggleColorMode} />}
                    label=""
